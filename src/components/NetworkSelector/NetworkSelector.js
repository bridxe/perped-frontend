...
export default function NetworkSelector(props) {
    ...
    function renderOption(option) {
        ...
        return ( <
            div className = { cx("Selector-option", option.label) }
            onClick = {
                () => onSelect(option)
            }
            key = { option.value } >
            <
            img src = { optionIcon.default }
            alt = { option.icon }
    ...
    function SingleValue({ data, ...props }) {
        ...
        return ( <
            ...
            className = "network-label" > { data.label } <
            /span> < /
            div > <
    ...
    return ( <
            div className = { cx("Selector", className, { disabled }) } > {
                ...
                small ? ( <
                    div className = { cx("Selector-box", value.label) }
                    onClick = {
                        () => toggleModal(true)
                    } >
                    <
                    img src = { valueIcon.default }
                    alt = "valueIcon" / > {
                        showCaret && < img src = { selectorDropdowns }
                        alt = "selectorDropdowns" / >
                    } <
                    /div>
                ) : ( <
                    ...
                    getOptionLabel = {
                        (e) => {
                            ...
                            return ( <
                                    ...
                                    className = "network-label" > { e.label } <
                                    /span> {
